package io.github.jhipster.travis.config.timezone;

import io.github.jhipster.travis.TravisReactApp;
import io.github.jhipster.travis.repository.timezone.DateTimeWrapper;
import io.github.jhipster.travis.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM my_prefix_date_time_wrapper where id=%d", fieldName, id);
    }
